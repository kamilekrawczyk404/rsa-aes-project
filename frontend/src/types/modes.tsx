...
import { Copy, Link, Radio, RefreshCcw, ShieldCheck, Zap } from "lucide-react";
...
export const AES_MODE_DETAILS: AesModeDetails = {
  ...
  GCM: {
    label: "Galois/Counter Mode",
    description:
      "Tryb łączący szyfrowanie i uwierzytelnianie danych. Zapewnia integralność i poufność. Bardzo szybki i bezpieczny, często używany w nowoczesnych aplikacjach.",
    icon: <ShieldCheck size="1.2em" />,
    isSecure: true,
  },
  // CFB: {
